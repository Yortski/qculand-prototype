...
export default function FacultyPlayerUI() {
  return (
    <motion.div
    ...
    >
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg px-6 py-3">
        <h3 className="text-lg font-bold text-gray-800 mb-2 text-center">👨‍🏫 Faculty Office Controls</h3>
        <div className="text-sm text-gray-700 space-y-1">
          ...
          <div className="pt-2 border-t border-gray-300">
            <span className="font-semibold">💼 Click Cipher to investigate</span>
          </div>
        </div>
      </div>
    </motion.div>
